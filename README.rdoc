== Install and run RVM with bundler on Windows
orig: link:https://www.drupal.org/node/2138087

* Last updated February 15, 2015. Created on November 18, 2013.
...
Make sure you install the 32-bit version of cygwin, as otherwise you could get errors when trying to compile your ruby when installing it through rvm. So Install cygwin with following packages and their dependencies:
    ...
    automake, bison, colorgcc, curl, gcc-g++, gcc-core, git, git-completion, git-gui,
    git-svn, gitk, libreadline7, libtool, libyaml-devel, libyaml0_2, make, mercurial,
    mingw64-i686-gcc-g++, nano, ncurses, openssh, openssl, openssl-devel, patch, readline,
    unzip, zlib, zlib-devel, sqlite3, mingw64-x86_64-gcc
...
====Check that all cygwin requirements for RVM are installed. Run:
    rvm requirements 
